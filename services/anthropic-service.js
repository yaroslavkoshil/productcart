...
4. МОВА: СУВОРО 100% УКРАЇНСЬКА! Категорично заборонено використовувати російські слова. Бренд або англійські назви можна залишити англійською.
5. Не вигадуй характеристики, яких немає в описі (якщо не вказано "1000 мл", не пиши це). Але якщо вони є в описі, обов'язково використовуй їх у ключах (наприклад "кондиціонер для волосся 5л").
...
2. Ти можеш логічно додумувати характеристики, навіть якщо їх немає в тексті прямо (наприклад, якщо це шампунь з ментолом, він "Освіжаючий", якщо дитячий — "Гіпоалергенний" тощо). Якщо це на 100% логічно випливає з суті та призначення товару — обирай це значення.
3. Якщо ти зовсім не впевнений і характеристику неможливо логічно вивести — краще пропусти її.
4. Для типу "multiselect" ти можеш повернути масив з кількох дозволених значень (наприклад ["Зволоження", "Відновлення", "Освіжаючий"]). Для "singleselect" — тільки один рядок.
