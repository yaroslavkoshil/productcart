            ...
            setTimeout(() => {
                ...
                if (btn) {
                    btn.addEventListener('click', async () => {
                        ...
                        if (!url.includes('hash_key=') && !url.includes('token=')) {
                            return alert('❌ Помилка: Посилання повинно містити "hash_key=" або "token="! Згенеруйте правильне посилання в кабінеті Prom.ua.');
                        }
                        btn.disabled = true;
